...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 12, 2025 lúc 03:27 AM
...
(68, 'GIGABYTE', 'GeForce RTX™ 4070 SUPER', '7168 Units', '21Gbps', '12GB', '700W'),
(69, 'GIGABYTE', 'AMD Radeon RX 9070', '3584 Units', '20Gbps', '16GB', '750W'),
(70, 'ASUS', 'Radeon RX 6500 XT', '1024 Units', '18Gbps', '4GB', '500W'),
(71, 'Asus', 'GeForce RTX 5090', '21760 Units', '28Gbps', '32GB', '1000W'),
(72, 'Gigabyte', 'GeForce RTX 3060', '3584 Units', '4Gbps', '12GB', '550W');
...
(62, 'Lenovo', 'Intel Core Ultra 7', 'Intel Arc Graphics', '32GB', '1TB', '14 inch', '3840x2400'),
(65, 'Lenovo', 'Intel Core i5-13420H', 'Intel UHD Graphics', '32GB', '1TB', '14 inch', '1920x1200');
...
(49, 'Acer', 'NVIDIA GeForce RTX 4050 6GB', 'Intel Core i7-14700HX', '32GB', '512GB', '16 inch', '2560x1600'),
(51, 'Lenovo', 'NVIDIA GeForce RTX 4060 8GB', 'Intel Core i7-14650HX', '16GB', '512GB', '16 inch', '2560x1600'),
(53, 'Acer', 'NVIDIA GeForce RTX 4070 8GB', 'Intel Core i7-13700HX', '16GB', '512GB', '16 inch', '2560x1600'),
(54, 'Asus', 'NVIDIA GeForce RTX 4060 8GB', 'AMD Ryzen AI 9 HX 370', '16GB', '1TB', '14 inch', '2560x1600'),
(61, 'Acer', 'NVIDIA GeForce RTX 4060 8GB', 'Intel Core i9-13900H', '16GB', '512GB', '15.6 inch', '1920x1080'),
(60, 'MSI', 'NVIDIA GeForce RTX 3050 6GB', 'Intel Core i7-13620H', '16GB', '512GB', '15.6 inch', '1920x1080'),
(59, 'Lenovo', 'NVIDIA GeForce RTX 4070 8GB', 'Intel Core i9-14900HX', '32GB', '1TB', '16 inch', '3200x3200'),
(58, 'MSI', 'NVIDIA GeForce RTX 5070 Ti 2GB', 'Intel Core Ultra 7 255HX', '16GB', '512GB', '16 inch', '2560x1600'),
(57, 'MSI', 'NVIDIA GeForce RTX 4050 6GB', 'Intel Core i7-14700HX', '16GB', '1TB', '16 inch', '1920x1200'),
(56, 'HP', 'NVIDIA GeForce RTX 4070 8GB', 'Intel Core i9-14900HX', '32GB', '1TB', '16 inch', '2560x1440'),
(66, 'Asus', 'NVIDIA Geforce RTX 2050', 'AMD Ryzen 7 7435HS', '16GB', '512GB', '15.6 inch', '1920x1080'),
(63, 'Lenovo', 'NVIDIA GeForce RTX 2050 4GB', 'Intel Core i5-12450HX', '12GB', '512GB', '15.6 inch', '1920x1080');
...
CREATE TABLE `orders` (
  ...
  `TrangThai` enum('đã nhận hàng','chờ xác nhận','đang giao','đã xác nhận') NOT NULL,
...
(2, 2, '229 cao thăng, p13, q4, hcm', '2025-05-10 11:49:45', NULL, 32070000, 'đang giao', 'chuyển khoản'),
...
(5, 4, 'Biệt thự số 12, đường Lê Quý Đôn, Quận 3, TP.HCM', NULL, NULL, 11490000, 'đã nhận hàng', 'tiền mặt'),
(6, 4, 'Biệt thự số 12, đường Lê Quý Đôn, Quận 3, TP.HCM', NULL, NULL, 11490000, 'đang giao', 'tiền mặt'),
(7, 1, 'Bãi sau Vũng Tàu', '2025-05-12 05:20:02', NULL, 176440000, 'đang giao', 'tiền mặt'),
(8, 2, '229 cao thăng, p13, q4, hcm', '2025-05-12 07:51:39', NULL, 78760000, 'chờ xác nhận', 'chuyển khoản');
...
(2, 'Laptop ASUS VivoBook Go 14 E1404FA-NK177W', 'Laptop', './assets/image/e1404fa-1.png', 196, 75, 11490000, 'hiện'),
...
(58, 'Laptop gaming MSI Vector 16 HX AI A2XWHG 010VN', 'LaptopGaming', './assets/image/1746955011_1024__1__035bd6ee5a8246078c525b4bc8d2e55b_grande.jpg', 76, 0, 54990000, 'hiện'),
(59, 'Laptop gaming Lenovo Legion 7 16IRX9 83FD004MVN', 'LaptopGaming', './assets/image/1746955134_ava_1388feab03cd40a2ad5b495d909a0a60_grande.jpg', 126, 0, 59990000, 'hiện'),
(60, 'Laptop gaming MSI Thin 15 B13UC 2044VN', 'LaptopGaming', './assets/image/1746955252_thin-new_d31ff3b88e7f40e7ac88acc624e03d4f_grande.jpg', 220, 0, 19290000, 'hiện'),
...
(62, 'Laptop Lenovo Yoga Slim 9 14ILL10 83CX001AVN', 'Laptop', './assets/image/1747003302_text_ng_n_17__8_111.jpg', 34, 0, 59990000, 'hiện'),
(63, 'Laptop Lenovo LOQ 15IAX9 83GS001SVN', 'LaptopGaming', './assets/image/1747003704_text_ng_n_-_2024-03-15t205946.150.jpg', 178, 0, 20990000, 'hiện'),
(65, 'Laptop Lenovo IdeaPad Slim 5 OLED 14IRH10', 'Laptop', './assets/image/1747004290_text_ng_n_17__8_59.jpg', 132, 0, 23490000, 'hiện'),
(66, 'Laptop ASUS TUF Gaming A15 FA506NFR-HN006W', 'LaptopGaming', './assets/image/1747004475_text_ng_n_14__6_64.jpg', 123, 0, 16990000, 'hiện'),
(67, 'Laptop HP Gaming Victus 16-S0173AX A9LG9PA', 'LaptopGaming', './assets/image/1747004788_text_ng_n_23__2_40.jpg', 44, 0, 27350000, 'hiện'),
(68, 'Card màn hình GIGABYTE GeForce RTX 4070 SUPER WINDFORCE', 'GPU', './assets/image/1747011522_Screenshot 2025-05-12 075833.png', 25, 0, 19490000, 'hiện'),
(69, 'Card màn hình GIGABYTE Radeon RX 9070', 'GPU', './assets/image/1747011767_Screenshot 2025-05-12 080240.png', 15, 0, 19990000, 'hiện'),
(70, 'Card màn hình Gigabyte GeForce RTX 3060', 'GPU', './assets/image/1747011962_Screenshot 2025-05-12 080557.png', 30, 0, 7690000, 'hiện'),
(71, 'Card màn hình Asus TUF Gaming GeForce RTX 5090 32GB', 'GPU', './assets/image/1747012087_Screenshot 2025-05-12 080801.png', 5, 0, 105000000, 'hiện'),
(72, 'Card màn hình ASUS Dual Radeon RX 6500 XT', 'GPU', './assets/image/1747012258_Screenshot 2025-05-12 081013.png', 50, 0, 3490000, 'hiện');
...
CREATE TABLE `users` (
  ...
  `TrangThai` enum('mở','khóa') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `orders`
  MODIFY `MaDon` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
